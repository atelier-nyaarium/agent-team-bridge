...
**Loop status:** P0 done. **P1/P2 DONE + sealed.** **P3 DONE + sealed** (clean break: composite registration via PROJECT_NAME override + composite wake + durable resume map + `--resume` + DATA_DIR migration + catalog split + docker-exec swap, `5b40759`..`db3e78c`; CI green, 728 tests). **P4 next** - start with its plan-refinement cycle.
