...
export const CODEX_THINKING_INSTRUCTIONS = [
	...
	"- An iterating dimension reuses that one thread across its attempts rather than starting a fresh",
	"  agent per loop. A thread holding its own last three failures fixes the fourth.",
