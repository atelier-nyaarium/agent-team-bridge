 ...
 * rather than skips. This is where the cursor becomes console-owned and durable: the console
 * never re-adopts a server-dictated cursor, which would otherwise let a reconnect delete
 * backlog already delivered.
 */
